...
use adapter::{
    ...
    redis::RedisClient,
    repository::{health::HealthCheckRepositoryImpl, auth::AuthRepositoryImpl, book::BookRepositoryImpl},
};
use kernel::repository::{book::BookRepository, health::HealthCheckRepository, auth::AuthRepository};
